...
union link_misc_perst_deco_ctrl {
	struct {
		uint32_t	bcm7412_rst:1;		
		uint32_t	reserved0:3;		
		uint32_t	stop_bcm_7412_clk:1;	
...
union link_misc_perst_clk_ctrl {
	struct {
		uint32_t	sel_alt_clk:1;	  
		uint32_t	stop_core_clk:1;  
		uint32_t	pll_pwr_dn:1;	  
...
union link_misc_perst_decoder_ctrl {
	struct {
		uint32_t	bcm_7412_rst:1; 
		uint32_t	res0:3; 
		uint32_t	stop_7412_clk:1; 
		uint32_t	res1:27; 
	};
...
struct dma_descriptor {	
	...
	uint32_t res2:2;		
	uint32_t xfer_size:23;		
	uint32_t res3:6;		
	uint32_t intr_enable:1;		

	
	uint32_t endian_xlat_align:2;	
	uint32_t next_desc_cont:1;	
	uint32_t res4:25;		
	uint32_t fill_bytes:2;		
	uint32_t dma_dir:1;		
	uint32_t last_rec_indicator:1;	

	
	uint32_t next_desc_addr_low;	

	
	uint32_t next_desc_addr_high;	
