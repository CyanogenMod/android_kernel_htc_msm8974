...
#define DEVCAP_VAL_ADOPTER_ID_H    (uint8_t)(LOCAL_ADOPTER_ID >>   8)
#define DEVCAP_VAL_ADOPTER_ID_L    (uint8_t)(LOCAL_ADOPTER_ID & 0xFF)
#define DEVCAP_VAL_VID_LINK_MODE   (MHL_DEV_VID_LINK_SUPPRGB444 | MHL_DEV_VID_LINK_SUPP_PPIXEL | MHL_DEV_VID_LINK_SUPP_VGA)
