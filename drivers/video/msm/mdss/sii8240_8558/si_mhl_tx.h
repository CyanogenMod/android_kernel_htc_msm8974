...
typedef struct _si_mhl_tx_drv_mode_flags_t 
{
	unsigned debug_messages				:1;
	unsigned hdcp_mode					:1;
	unsigned allow_D3					:1;
    unsigned transcode_mode 			:1;
	unsigned packed_pixel_user_control	:1;
	unsigned packed_pixel_user_on		:1;
	unsigned reserved					:2;
}si_mhl_tx_drv_mode_flags_t;
