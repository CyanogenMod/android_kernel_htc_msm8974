...
#define CRYPTO_AUTH_SIZE			11	
#define CRYPTO_AUTH_SIZE_MASK			(7 << CRYPTO_AUTH_SIZE)

#define CRYPTO_AUTH_ALG				9	
...
#define CRYPTO_ENCR_SEG_SIZE			16	
...
#define CRYPTO_AUTH_SEG_SIZE			16	
