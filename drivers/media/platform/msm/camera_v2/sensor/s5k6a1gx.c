...
#define s5k6a1gx_SENSOR_NAME "s5k6a1gx"
DEFINE_MSM_MUTEX(s5k6a1gx_mut);

static struct msm_sensor_ctrl_t s5k6a1gx_s_ctrl;

static struct msm_sensor_power_setting s5k6a1gx_power_setting[] = {
...
static const struct i2c_device_id s5k6a1gx_i2c_id[] = {
	{s5k6a1gx_SENSOR_NAME, (kernel_ulong_t)&s5k6a1gx_s_ctrl},
	{ }
};
