...
#define MMC_CNTRL		0x00000100	
#define MMC_RX_INTR		0x00000104	
#define MMC_TX_INTR		0x00000108	
#define MMC_RX_INTR_MASK	0x0000010c	
#define MMC_TX_INTR_MASK	0x00000110	
