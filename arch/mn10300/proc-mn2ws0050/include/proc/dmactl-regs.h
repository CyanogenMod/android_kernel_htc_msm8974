...
#define	DMxCTR(N)		__SYSREG(0xd4005000+(N*0x100), u32)	
...
#define	DMxCTR_BG_RYBY		0x0000000d	
#define	DMxCTR_BG_RMC		0x0000000e	
#define	DMxCTR_BG_XIRQ12	0x00000011	
#define	DMxCTR_BG_XIRQ13	0x00000012	
#define	DMxCTR_BG_TCK		0x00000014	
#define	DMxCTR_BG_SC4TX		0x00000019	
#define	DMxCTR_BG_SC4RX		0x0000001a	
#define	DMxCTR_BG_SC5TX		0x0000001b	
#define	DMxCTR_BG_SC5RX		0x0000001c	
#define	DMxCTR_BG_SC6TX		0x0000001d	
#define	DMxCTR_BG_SC6RX		0x0000001e	
#define	DMxCTR_BG_TMSUFLOW	0x0000001f	
#define	DMxCTR_SAM		0x00000060	
#define	DMxCTR_SAM_INCR		0x00000000	
#define	DMxCTR_SAM_DECR		0x00000020	
#define	DMxCTR_SAM_FIXED	0x00000040	
#define	DMxCTR_DAM		0x00000300	
...
#define	DMxCTR_PERR		0x40000000	
#define	DMxCTR_XEND		0x80000000	

#define	DMxSRC(N)		__SYSREG(0xd4005004+(N*0x100), u32)	

#define	DMxDST(N)		__SYSREG(0xd4005008+(N*0x100), u32)	

#define	DMxSIZ(N)		__SYSREG(0xd400500c+(N*0x100), u32)	
#define DMxSIZ_CT		0x000fffff	

#define	DMxCYC(N)		__SYSREG(0xd4005010+(N*0x100), u32)	
