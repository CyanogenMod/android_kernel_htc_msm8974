...
#define IRQ_TC11MP_PB_IRQ1	(IRQ_TC11MP_GIC_START + 10)		
#define IRQ_TC11MP_PB_IRQ2	(IRQ_TC11MP_GIC_START + 11)		
#define IRQ_TC11MP_PB_FIQ1	(IRQ_TC11MP_GIC_START + 12)		
#define IRQ_TC11MP_PB_FIQ2	(IRQ_TC11MP_GIC_START + 13)		
...
#define IRQ_PB11MP_WATCHDOG	(IRQ_PB11MP_GIC_START + 0)	
#define IRQ_PB11MP_SOFT		(IRQ_PB11MP_GIC_START + 1)	
#define IRQ_PB11MP_COMMRx	(IRQ_PB11MP_GIC_START + 2)	
#define IRQ_PB11MP_COMMTx	(IRQ_PB11MP_GIC_START + 3)	
#define IRQ_PB11MP_GPIO0	(IRQ_PB11MP_GIC_START + 6)	
#define IRQ_PB11MP_GPIO1	(IRQ_PB11MP_GIC_START + 7)	
#define IRQ_PB11MP_GPIO2	(IRQ_PB11MP_GIC_START + 8)	
								
#define IRQ_PB11MP_RTC_GIC1	(IRQ_PB11MP_GIC_START + 10)	
#define IRQ_PB11MP_SSP		(IRQ_PB11MP_GIC_START + 11)	
#define IRQ_PB11MP_UART0_GIC1	(IRQ_PB11MP_GIC_START + 12)	
#define IRQ_PB11MP_UART1_GIC1	(IRQ_PB11MP_GIC_START + 13)	
#define IRQ_PB11MP_UART2	(IRQ_PB11MP_GIC_START + 14)	
#define IRQ_PB11MP_UART3	(IRQ_PB11MP_GIC_START + 15)	
#define IRQ_PB11MP_SCI		(IRQ_PB11MP_GIC_START + 16)	
#define IRQ_PB11MP_MMCI0A_GIC1	(IRQ_PB11MP_GIC_START + 17)	
#define IRQ_PB11MP_MMCI0B_GIC1	(IRQ_PB11MP_GIC_START + 18)	
#define IRQ_PB11MP_AACI_GIC1	(IRQ_PB11MP_GIC_START + 19)	
#define IRQ_PB11MP_KMI0_GIC1	(IRQ_PB11MP_GIC_START + 20)	
#define IRQ_PB11MP_KMI1_GIC1	(IRQ_PB11MP_GIC_START + 21)	
#define IRQ_PB11MP_CHARLCD	(IRQ_PB11MP_GIC_START + 22)	
#define IRQ_PB11MP_CLCD		(IRQ_PB11MP_GIC_START + 23)	
#define IRQ_PB11MP_DMAC		(IRQ_PB11MP_GIC_START + 24)	
#define IRQ_PB11MP_PWRFAIL	(IRQ_PB11MP_GIC_START + 25)	
#define IRQ_PB11MP_PISMO	(IRQ_PB11MP_GIC_START + 26)	
#define IRQ_PB11MP_DoC		(IRQ_PB11MP_GIC_START + 27)	
#define IRQ_PB11MP_ETH_GIC1	(IRQ_PB11MP_GIC_START + 28)	
#define IRQ_PB11MP_USB_GIC1	(IRQ_PB11MP_GIC_START + 29)	
#define IRQ_PB11MP_TSPEN	(IRQ_PB11MP_GIC_START + 30)	
#define IRQ_PB11MP_TSKPAD	(IRQ_PB11MP_GIC_START + 31)	
