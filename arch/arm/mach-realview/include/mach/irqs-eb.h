...
#define IRQ_EB_WDOG		(IRQ_EB_GIC_START + 0)		
#define IRQ_EB_SOFT		(IRQ_EB_GIC_START + 1)		
#define IRQ_EB_COMMRx		(IRQ_EB_GIC_START + 2)		
#define IRQ_EB_COMMTx		(IRQ_EB_GIC_START + 3)		
#define IRQ_EB_TIMER0_1		(IRQ_EB_GIC_START + 4)		
#define IRQ_EB_TIMER2_3		(IRQ_EB_GIC_START + 5)		
#define IRQ_EB_GPIO0		(IRQ_EB_GIC_START + 6)		
#define IRQ_EB_GPIO1		(IRQ_EB_GIC_START + 7)		
#define IRQ_EB_GPIO2		(IRQ_EB_GIC_START + 8)		
								
#define IRQ_EB_RTC		(IRQ_EB_GIC_START + 10)		
#define IRQ_EB_SSP		(IRQ_EB_GIC_START + 11)		
#define IRQ_EB_UART0		(IRQ_EB_GIC_START + 12)		
#define IRQ_EB_UART1		(IRQ_EB_GIC_START + 13)		
#define IRQ_EB_UART2		(IRQ_EB_GIC_START + 14)		
#define IRQ_EB_UART3		(IRQ_EB_GIC_START + 15)		
#define IRQ_EB_SCI		(IRQ_EB_GIC_START + 16)		
#define IRQ_EB_MMCI0A		(IRQ_EB_GIC_START + 17)		
#define IRQ_EB_MMCI0B		(IRQ_EB_GIC_START + 18)		
#define IRQ_EB_AACI		(IRQ_EB_GIC_START + 19)		
#define IRQ_EB_KMI0		(IRQ_EB_GIC_START + 20)		
#define IRQ_EB_KMI1		(IRQ_EB_GIC_START + 21)		
#define IRQ_EB_CHARLCD		(IRQ_EB_GIC_START + 22)		
#define IRQ_EB_CLCD		(IRQ_EB_GIC_START + 23)		
#define IRQ_EB_DMA		(IRQ_EB_GIC_START + 24)		
#define IRQ_EB_PWRFAIL		(IRQ_EB_GIC_START + 25)		
#define IRQ_EB_PISMO		(IRQ_EB_GIC_START + 26)		
#define IRQ_EB_DoC		(IRQ_EB_GIC_START + 27)		
#define IRQ_EB_ETH		(IRQ_EB_GIC_START + 28)		
#define IRQ_EB_USB		(IRQ_EB_GIC_START + 29)		
#define IRQ_EB_TSPEN		(IRQ_EB_GIC_START + 30)		
#define IRQ_EB_TSKPAD		(IRQ_EB_GIC_START + 31)		
...
#define IRQ_EB11MP_EB_IRQ1	(IRQ_EB_GIC_START + 10)		
#define IRQ_EB11MP_EB_IRQ2	(IRQ_EB_GIC_START + 11)		
#define IRQ_EB11MP_EB_FIQ1	(IRQ_EB_GIC_START + 12)		
#define IRQ_EB11MP_EB_FIQ2	(IRQ_EB_GIC_START + 13)		
