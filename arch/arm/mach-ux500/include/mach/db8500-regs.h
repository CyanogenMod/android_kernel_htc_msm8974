...
#define U8500_DMA_BASE		0x801C0000	
...
#define U8500_MTU0_BASE		(U8500_PER6_BASE + 0x6000) 
#define U8500_MTU1_BASE		(U8500_PER6_BASE + 0x7000) 
#define U8500_CR_BASE		(U8500_PER6_BASE + 0x8000) 
