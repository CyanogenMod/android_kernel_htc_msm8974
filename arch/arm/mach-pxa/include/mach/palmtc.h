...
#define PALMTC_BAT_MAX_VOLTAGE		4000	
#define PALMTC_BAT_MIN_VOLTAGE		3550	
#define PALMTC_BAT_MAX_CURRENT		0	
#define PALMTC_BAT_MIN_CURRENT		0	
#define PALMTC_BAT_MAX_CHARGE		1	
#define PALMTC_BAT_MIN_CHARGE		1	
#define PALMTC_MAX_LIFE_MINS		240	
