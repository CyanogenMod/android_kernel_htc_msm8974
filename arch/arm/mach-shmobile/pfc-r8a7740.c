...
static struct pinmux_gpio pinmux_gpios[] = {
	...
	GPIO_FN(FSIAISLD_PORT0),	
	GPIO_FN(FSIAISLD_PORT5),
	GPIO_FN(FSIASPDIF_PORT9),	
	...
	GPIO_FN(SCIFA4_RXD_PORT12), 
	GPIO_FN(SCIFA4_TXD_PORT13),

	GPIO_FN(SCIFA4_RXD_PORT204), 
	GPIO_FN(SCIFA4_TXD_PORT203),

	GPIO_FN(SCIFA4_RXD_PORT94), 
	GPIO_FN(SCIFA4_TXD_PORT93),

	GPIO_FN(SCIFA4_SCK_PORT21), 
	GPIO_FN(SCIFA4_SCK_PORT205),

	
	GPIO_FN(SCIFA5_TXD_PORT20), 
	GPIO_FN(SCIFA5_RXD_PORT10),

	GPIO_FN(SCIFA5_RXD_PORT207), 
	GPIO_FN(SCIFA5_TXD_PORT208),

	GPIO_FN(SCIFA5_TXD_PORT91), 
	GPIO_FN(SCIFA5_RXD_PORT92),

	GPIO_FN(SCIFA5_SCK_PORT23), 
	...
	GPIO_FN(VIO0_D13_PORT26), 
	GPIO_FN(VIO0_D14_PORT25),
	GPIO_FN(VIO0_D15_PORT24),

	GPIO_FN(VIO0_D13_PORT22), 
	...
	GPIO_FN(SDHI2_CD_PORT24), 
	GPIO_FN(SDHI2_WP_PORT25),

	GPIO_FN(SDHI2_WP_PORT177), 
	...
	GPIO_FN(CS5A_PORT105), 
	GPIO_FN(CS5A_PORT19),
	GPIO_FN(IOIS16), 

	GPIO_FN(A0),	GPIO_FN(A1),	GPIO_FN(A2),	GPIO_FN(A3),
	GPIO_FN(A4_FOE),	GPIO_FN(A5_FCDE),	
	...
	GPIO_FN(D0_NAF0),	GPIO_FN(D1_NAF1),	
	GPIO_FN(D2_NAF2),	GPIO_FN(D3_NAF3),	
	GPIO_FN(D4_NAF4),	GPIO_FN(D5_NAF5),	
	GPIO_FN(D6_NAF6),	GPIO_FN(D7_NAF7),	
	GPIO_FN(D8_NAF8),	GPIO_FN(D9_NAF9),	
	GPIO_FN(D10_NAF10),	GPIO_FN(D11_NAF11),	
	GPIO_FN(D12_NAF12),	GPIO_FN(D13_NAF13),	
	...
	GPIO_FN(RD_FSC),	
	GPIO_FN(WAIT_PORT177), 
	GPIO_FN(WAIT_PORT90),

	GPIO_FN(FCE0),	GPIO_FN(FCE1),	GPIO_FN(FRB), 
	...
	GPIO_FN(RMII_REF50CK),	GPIO_FN(RMII_REF125CK),	

	
	GPIO_FN(ET_TX_CLK),	GPIO_FN(ET_TX_EN),	GPIO_FN(ET_ETXD0),
	GPIO_FN(ET_ETXD1),	GPIO_FN(ET_ETXD2),	GPIO_FN(ET_ETXD3),
	GPIO_FN(ET_ETXD4),	GPIO_FN(ET_ETXD5), 
	GPIO_FN(ET_ETXD6),	GPIO_FN(ET_ETXD7), 
	...
	GPIO_FN(ET_ERXD4),	GPIO_FN(ET_ERXD5), 
	GPIO_FN(ET_ERXD6),	GPIO_FN(ET_ERXD7), 
