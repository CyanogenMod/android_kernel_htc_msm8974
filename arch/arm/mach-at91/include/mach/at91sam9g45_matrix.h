...
#define AT91_MATRIX_MCFG9	0x24			
#define AT91_MATRIX_MCFG10	0x28			
#define AT91_MATRIX_MCFG11	0x2C			
...
#define AT91_MATRIX_VIDEO	0x118			
#define		AT91C_VDEC_SEL			(0x1 <<  0) 
#define			AT91C_VDEC_SEL_OFF		(0 << 0)
#define			AT91C_VDEC_SEL_ON		(1 << 0)

#define AT91_MATRIX_EBICSA	0x128			
