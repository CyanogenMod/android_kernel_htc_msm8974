...
#define PLD_IRQ_INT0		(M32104UT_PLD_IRQ_BASE + 0)	
#define PLD_IRQ_CFIREQ		(M32104UT_PLD_IRQ_BASE + 3)	
#define PLD_IRQ_CFC_INSERT	(M32104UT_PLD_IRQ_BASE + 4)	
#define PLD_IRQ_CFC_EJECT	(M32104UT_PLD_IRQ_BASE + 5)	
#define PLD_IRQ_EXINT		(M32104UT_PLD_IRQ_BASE + 6)	
#define PLD_IRQ_MMCCARD		(M32104UT_PLD_IRQ_BASE + 11)	
#define PLD_IRQ_SC_ERROR	(M32104UT_PLD_IRQ_BASE + 13)	
#define PLD_IRQ_SC_RCV		(M32104UT_PLD_IRQ_BASE + 14)	
#define PLD_IRQ_SC_SND		(M32104UT_PLD_IRQ_BASE + 15)	
...
#define PLD_ICUCR_ISMOD00	(0x0000)	
#define PLD_ICUCR_ISMOD01	(0x0010)	
#define PLD_ICUCR_ISMOD02	(0x0020)	
#define PLD_ICUCR_ISMOD03	(0x0030)	
