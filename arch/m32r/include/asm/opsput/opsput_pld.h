...
#define PLD_IRQ_INT0		(OPSPUT_PLD_IRQ_BASE + 0)	
#define PLD_IRQ_INT1		(OPSPUT_PLD_IRQ_BASE + 1)	
#define PLD_IRQ_INT2		(OPSPUT_PLD_IRQ_BASE + 2)	
#define PLD_IRQ_CFIREQ		(OPSPUT_PLD_IRQ_BASE + 3)	
#define PLD_IRQ_CFC_INSERT	(OPSPUT_PLD_IRQ_BASE + 4)	
#define PLD_IRQ_CFC_EJECT	(OPSPUT_PLD_IRQ_BASE + 5)	
#define PLD_IRQ_EXINT		(OPSPUT_PLD_IRQ_BASE + 6)	
#define PLD_IRQ_INT7		(OPSPUT_PLD_IRQ_BASE + 7)	
#define PLD_IRQ_INT8		(OPSPUT_PLD_IRQ_BASE + 8)	
#define PLD_IRQ_INT9		(OPSPUT_PLD_IRQ_BASE + 9)	
#define PLD_IRQ_INT10		(OPSPUT_PLD_IRQ_BASE + 10)	
#define PLD_IRQ_MMCCARD		(OPSPUT_PLD_IRQ_BASE + 11)	
#define PLD_IRQ_INT12		(OPSPUT_PLD_IRQ_BASE + 12)	
#define PLD_IRQ_SC_ERROR	(OPSPUT_PLD_IRQ_BASE + 13)	
#define PLD_IRQ_SC_RCV		(OPSPUT_PLD_IRQ_BASE + 14)	
#define PLD_IRQ_SC_SND		(OPSPUT_PLD_IRQ_BASE + 15)	
#define PLD_IRQ_SIO0_RCV	(OPSPUT_PLD_IRQ_BASE + 16)	
#define PLD_IRQ_SIO0_SND	(OPSPUT_PLD_IRQ_BASE + 17)	
#define PLD_IRQ_INT18		(OPSPUT_PLD_IRQ_BASE + 18)	
#define PLD_IRQ_INT19		(OPSPUT_PLD_IRQ_BASE + 19)	
#define PLD_IRQ_INT20		(OPSPUT_PLD_IRQ_BASE + 20)	
#define PLD_IRQ_INT21		(OPSPUT_PLD_IRQ_BASE + 21)	
#define PLD_IRQ_INT22		(OPSPUT_PLD_IRQ_BASE + 22)	
#define PLD_IRQ_INT23		(OPSPUT_PLD_IRQ_BASE + 23)	
#define PLD_IRQ_INT24		(OPSPUT_PLD_IRQ_BASE + 24)	
#define PLD_IRQ_INT25		(OPSPUT_PLD_IRQ_BASE + 25)	
#define PLD_IRQ_INT26		(OPSPUT_PLD_IRQ_BASE + 26)	
#define PLD_IRQ_INT27		(OPSPUT_PLD_IRQ_BASE + 27)	
#define PLD_IRQ_INT28		(OPSPUT_PLD_IRQ_BASE + 28)	
#define PLD_IRQ_INT29		(OPSPUT_PLD_IRQ_BASE + 29)	
#define PLD_IRQ_INT30		(OPSPUT_PLD_IRQ_BASE + 30)	
#define PLD_IRQ_INT31		(OPSPUT_PLD_IRQ_BASE + 31)	
...
#define PLD_IRQ_INT1		(OPSPUT_PLD_IRQ_BASE + 1)	
#define PLD_IRQ_INT2		(OPSPUT_PLD_IRQ_BASE + 2)	
#define PLD_IRQ_CF0		(OPSPUT_PLD_IRQ_BASE + 3)	
#define PLD_IRQ_CF1		(OPSPUT_PLD_IRQ_BASE + 4)	
#define PLD_IRQ_CF2		(OPSPUT_PLD_IRQ_BASE + 5)	
#define PLD_IRQ_CF3		(OPSPUT_PLD_IRQ_BASE + 6)	
#define PLD_IRQ_CF4		(OPSPUT_PLD_IRQ_BASE + 7)	
#define PLD_IRQ_INT8		(OPSPUT_PLD_IRQ_BASE + 8)	
#define PLD_IRQ_INT9		(OPSPUT_PLD_IRQ_BASE + 9)	
#define PLD_IRQ_INT10		(OPSPUT_PLD_IRQ_BASE + 10)	
#define PLD_IRQ_INT11		(OPSPUT_PLD_IRQ_BASE + 11)	
#define PLD_IRQ_UART0		(OPSPUT_PLD_IRQ_BASE + 12)	
#define PLD_IRQ_UART1		(OPSPUT_PLD_IRQ_BASE + 13)	
#define PLD_IRQ_INT14		(OPSPUT_PLD_IRQ_BASE + 14)	
#define PLD_IRQ_INT15		(OPSPUT_PLD_IRQ_BASE + 15)	
#define PLD_IRQ_SNDINT		(OPSPUT_PLD_IRQ_BASE + 16)	
#define PLD_IRQ_INT17		(OPSPUT_PLD_IRQ_BASE + 17)	
#define PLD_IRQ_INT18		(OPSPUT_PLD_IRQ_BASE + 18)	
#define PLD_IRQ_INT19		(OPSPUT_PLD_IRQ_BASE + 19)	
#define PLD_IRQ_INT20		(OPSPUT_PLD_IRQ_BASE + 20)	
#define PLD_IRQ_INT21		(OPSPUT_PLD_IRQ_BASE + 21)	
