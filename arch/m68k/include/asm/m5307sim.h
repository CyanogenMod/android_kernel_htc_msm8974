...
#define MCFSIM_CSBAR		0x98		
#define MCFSIM_CSBAMR		0x9c		
#define MCFSIM_CSMR2		0x9e		
#define MCFSIM_CSCR2		0xa2		
#define MCFSIM_CSMR3		0xaa		
#define MCFSIM_CSCR3		0xae		
#define MCFSIM_CSMR4		0xb6		
#define MCFSIM_CSCR4		0xba		
#define MCFSIM_CSMR5		0xc2		
#define MCFSIM_CSCR5		0xc6		
#define MCFSIM_CSMR6		0xce		
#define MCFSIM_CSCR6		0xd2		
#define MCFSIM_CSMR7		0xda		
