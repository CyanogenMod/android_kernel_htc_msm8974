...
#define MB93493_VDC_RCURSOR	0x140	
#define MB93493_VDC_RCT1	0x144	
#define MB93493_VDC_RCT2	0x148	
#define MB93493_VDC_RHDC	0x150	
#define MB93493_VDC_RH_MARGINS	0x154	
#define MB93493_VDC_RVDC	0x158	
#define MB93493_VDC_RV_MARGINS	0x15c	
#define MB93493_VDC_RC		0x170	
#define MB93493_VDC_RCLOCK	0x174	
#define MB93493_VDC_RBLACK	0x178	
#define MB93493_VDC_RS		0x17c	
...
#define VDC_RC_DSR		0x00000080	

#define VDC_RS_IT		0x00060000	
#define VDC_RS_IT_UNDERFLOW	0x00040000	
#define VDC_RS_IT_VSYNC		0x00020000	
#define VDC_RS_DFI		0x00010000	
#define VDC_RS_DFI_TOP		0x00000000	
#define VDC_RS_DFI_BOTTOM	0x00010000	
#define VDC_RS_DCSR		0x00000010	
#define VDC_RS_DCM		0x00000003	
#define VDC_RS_DCM_DISABLED	0x00000000	
#define VDC_RS_DCM_STOPPED	0x00000001	
#define VDC_RS_DCM_FREERUNNING	0x00000002	
#define VDC_RS_DCM_TRANSFERRING	0x00000003	

#define __get_MB93493_VCC(X)	__get_MB93493(MB93493_VCC_##X)
#define __set_MB93493_VCC(X,V)	__set_MB93493(MB93493_VCC_##X, (V))

#define MB93493_VCC_RREDUCT	0x104	
#define MB93493_VCC_RHY		0x108	
#define MB93493_VCC_RHC		0x10c	
#define MB93493_VCC_RHSIZE	0x110	
#define MB93493_VCC_RHBC	0x114	
#define MB93493_VCC_RVCC	0x118	
#define MB93493_VCC_RVBC	0x11c	
#define MB93493_VCC_RV		0x120	
#define MB93493_VCC_RDTS	0x128	
#define MB93493_VCC_RDTS_4B	0x01000000	
#define MB93493_VCC_RDTS_32B	0x03000000	
#define MB93493_VCC_RDTS_SHIFT	24
#define MB93493_VCC_RCC		0x130	
#define MB93493_VCC_RIS		0x134	
...
#define VCC_RCC_CE		0x00000001	
#define VCC_RCC_CS		0x00000002	
#define VCC_RCC_CPF		0x0000000c	
#define VCC_RCC_CPF_YCBCR_16	0x00000000	
#define VCC_RCC_CPF_RGB		0x00000004	
#define VCC_RCC_CPF_YCBCR_24	0x00000008	
#define VCC_RCC_CPF_BT656	0x0000000c	
#define VCC_RCC_CPF_SHIFT	2
#define VCC_RCC_CSR		0x00000080	
#define VCC_RCC_HSIP		0x00000100	
#define VCC_RCC_HSIP_LOACT	0x00000000	
#define VCC_RCC_HSIP_HIACT	0x00000100	
#define VCC_RCC_VSIP		0x00000200	
#define VCC_RCC_VSIP_LOACT	0x00000000	
#define VCC_RCC_VSIP_HIACT	0x00000200	
#define VCC_RCC_CIE		0x00000800	
#define VCC_RCC_CFP		0x00001000	
#define VCC_RCC_CFP_4TO3	0x00000000	
#define VCC_RCC_CFP_1TO1	0x00001000	
#define VCC_RCC_CSM		0x00006000	
#define VCC_RCC_CSM_ONEPASS	0x00002000	
#define VCC_RCC_CSM_INTERLACE	0x00004000	
#define VCC_RCC_CSM_SHIFT	13
#define VCC_RCC_ES		0x00008000	
#define VCC_RCC_ES_NEG		0x00000000	
#define VCC_RCC_ES_POS		0x00008000	
#define VCC_RCC_IFI		0x00080000	
#define VCC_RCC_FDTS		0x00300000	
#define VCC_RCC_FDTS_3_8	0x00000000	
#define VCC_RCC_FDTS_1_4	0x00100000	
#define VCC_RCC_FDTS_7_16	0x00200000	
#define VCC_RCC_FDTS_SHIFT	20
#define VCC_RCC_MOV		0x00400000	
#define VCC_RCC_STP		0x00800000	
#define VCC_RCC_TO		0x01000000	

#define VCC_RIS_VSYNC		0x01000000	
#define VCC_RIS_OV		0x02000000	
#define VCC_RIS_BOTTOM		0x08000000	
#define VCC_RIS_STARTED		0x10000000	

#define MB93493_I2C_BSR 	0x340		
#define MB93493_I2C_BCR		0x344		
#define MB93493_I2C_CCR		0x348		
#define MB93493_I2C_ADR		0x34c		
#define MB93493_I2C_DTR		0x350		
#define MB93493_I2C_BC2R	0x35c		
...
#define MB93493_I2S_ALDR	0x300		
#define MB93493_I2S_ARDR	0x304		
#define MB93493_I2S_APDR	0x308		
#define MB93493_I2S_AISTR	0x310		
#define MB93493_I2S_AICR	0x314		
...
#define I2S_AISTR_OTST		0x00000003	
#define I2S_AISTR_OTR		0x00000010	
#define I2S_AISTR_OUR		0x00000020	
#define I2S_AISTR_OOR		0x00000040	
#define I2S_AISTR_ODS		0x00000100	
#define I2S_AISTR_ODE		0x00000400	
#define I2S_AISTR_OTRIE		0x00001000	
#define I2S_AISTR_OURIE		0x00002000	
#define I2S_AISTR_OORIE		0x00004000	
#define I2S_AISTR__OUT_MASK	0x00007570
#define I2S_AISTR_ITST		0x00030000	
#define I2S_AISTR_ITST_SHIFT	16
#define I2S_AISTR_ITR		0x00100000	
#define I2S_AISTR_IUR		0x00200000	
#define I2S_AISTR_IOR		0x00400000	
#define I2S_AISTR_IDS		0x01000000	
#define I2S_AISTR_IDE		0x04000000	
#define I2S_AISTR_ITRIE		0x10000000	
#define I2S_AISTR_IURIE		0x20000000	
#define I2S_AISTR_IORIE		0x40000000	
#define I2S_AISTR__IN_MASK	0x75700000

#define I2S_AICR_MI		0x00000001	
#define I2S_AICR_AMI		0x00000002	
#define I2S_AICR_LRI		0x00000004	
#define I2S_AICR_SDMI		0x00000070	
#define I2S_AICR_SDMI_SHIFT	4
#define I2S_AICR_CLI		0x00000080	
#define I2S_AICR_IM		0x00000300	
#define I2S_AICR_IM_SHIFT	8
#define I2S_AICR__IN_MASK	0x000003f7
#define I2S_AICR_MO		0x00001000	
#define I2S_AICR_AMO		0x00002000	
#define I2S_AICR_AMO_SHIFT	13
#define I2S_AICR_LRO		0x00004000	
#define I2S_AICR_SDMO		0x00070000	
#define I2S_AICR_SDMO_SHIFT	16
#define I2S_AICR_CLO		0x00080000	
#define I2S_AICR_OM		0x00100000	
#define I2S_AICR__OUT_MASK	0x001f7000
#define I2S_AICR_DIV		0x03000000	
#define I2S_AICR_DIV_SHIFT	24
#define I2S_AICR_FL		0x20000000	
#define I2S_AICR_FS		0x40000000	
#define I2S_AICR_ME		0x80000000	
