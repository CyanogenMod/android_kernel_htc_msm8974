...
static const struct brr_to_sig_map {
	unsigned long	brr_mask;	
	unsigned long	tbr_tt;		
	unsigned int	signo;		
} brr_to_sig_map[] = {
	...
	{ BRR_EB,	TBR_TT_INTERRUPT_13,	SIGALRM		},	
	{ BRR_EB,	TBR_TT_INTERRUPT_14,	SIGINT		},	
	{ BRR_EB,	TBR_TT_INTERRUPT_15,	SIGQUIT		},	
	{ BRR_CB,	0,			SIGUSR1		},
	{ BRR_TB,	0,			SIGUSR2		},
	{ BRR_DBNEx,	0,			SIGTRAP		},
	{ BRR_DBx,	0,			SIGTRAP		},	
