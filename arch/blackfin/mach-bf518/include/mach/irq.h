...
#define IRQ_PTP_ERROR		BFIN_IRQ(10)	
...
#define IRQ_SPI0_ERROR		BFIN_IRQ(47)	
#define IRQ_SPI1_ERROR		BFIN_IRQ(48)	
#define IRQ_RSI_INT0		BFIN_IRQ(51)	
#define IRQ_RSI_INT1		BFIN_IRQ(52)	
#define IRQ_PWM_TRIP		BFIN_IRQ(53)	
#define IRQ_PWM_SYNC		BFIN_IRQ(54)	
#define IRQ_PTP_STAT		BFIN_IRQ(55)	
