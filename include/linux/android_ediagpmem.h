...
#ifndef _ANDROID_EDIAGPMEM_H_
#define _ANDROID_EDIAGPMEM_H_
...
int get_ediagpmem_fd(int fd, unsigned long *start, unsigned long *end);
int get_ediagpmem_user_addr(struct file *file, unsigned long *start,
		       unsigned long *end);
void put_ediagpmem_file(struct file* file);
void put_ediagpmem_fd(int fd);
void flush_ediagpmem_fd(int fd, unsigned long start, unsigned long len);
void flush_ediagpmem_file(struct file *file, unsigned long start, unsigned long len);
int ediagpmem_cache_maint(struct file *file, unsigned int cmd,
