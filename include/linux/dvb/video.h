...
struct video_buffer_req {
	...
	struct video_buffer_prop input_buf_prop; 
	struct video_buffer_prop output_buf_prop; 
};
...
struct video_command {
	...
	union {
		...
		union {
			enum video_codec_t codec; 
			enum video_out_format_t format; 
			struct video_pic_res frame_res; 
			
			struct video_buffer_req buf_req;
			struct video_data_buffer buffer; 
