...
struct osd_capability_head {
	u8 format; 
	u8 integrity_algorithm__key_version; 
	u8 security_method;
	u8 reserved1;
	struct osd_timestamp expiration_time;
	u8 audit[20];
	u8 discriminator[12];
	struct osd_timestamp object_created_time;
	u8 object_type;
	u8 permissions_bit_mask[5];
	u8 reserved2;
	u8 object_descriptor_type; 
} __packed;
